...
<body>
    <div class="container">
        ...
        <div class="form-wraper">
            ...
            <form action="../handlers/insert_employee.php" method="POST" class="row g-3 my-5">
                    ...
                    <div class="col-9">
                      ...
                      <div class="col-9">
                        ...
                        <input type="text" name="designation" class="form-control" id="inputAddress" placeholder="Company Posstion" required autocomplete="none">
                      </div> <br>

                      <div class="col-9">
                        <label for="inputAddress" class="form-label">Department ID</label>
                        <input type="text" name="dept-id" class="form-control" id="inputAddress" placeholder=" i.e 1 (Administration)" required autocomplete="none">
                        <br>
