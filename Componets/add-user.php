...
<body>
    <div class="main">
        <div class="container-fluid pannel">
            ...
            <a id="active" style="text-decoration: none;" href="add-user.php"><div  class="options"> <span><img class="options-icons" src="../Assets/Images/person_add_FILL1_wght700_GRAD0_opsz48.svg" alt="add-user"></span><h6>Add User</h6></div></a> 
        ...
        <div class="grid">
            <div class="top">
                <a style="text-decoration: none;" href="./add_user_form.php">

                    <div class="cards">
                        <h1 class="titles">Add User</h1>
                        <span> <img class="svg" src="../Assets/Images/person_add_FILL1_wght700_GRAD0_opsz48.svg"> </span>
                   ...
                   <a style="text-decoration: none;" href="./all_users.php"> 

                        <div class="cards">
                            <h1 class="titles">Users</h1>
                            <span><img class="svg" src="../Assets/Images/recent_actors_FILL0_wght400_GRAD0_opsz48.svg" alt="loan-dues"></span>
            ...
            <div class="bottom">
                    <a style="text-decoration: none;" href="./add_employee_form.php">
                        <div class="cards">
                                <h1 class="titles">Add Employee</h1>
                                <span><img class="svg" src="../Assets/Images/badge_FILL0_wght400_GRAD0_opsz48.svg"></span>
                    ...
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                            ...
                            <h1 class="titles">Employees</h1>
                            <span><img class="svg" src="../Assets/Images/fact_check_FILL0_wght400_GRAD0_opsz48.svg" alt="loan-dues"></span>
