...
<body>
    <div class="main">
        <div class="container-fluid pannel">
            ...
            <a id="active"  style="text-decoration: none;"href="reports.php"><div  class="options"> <span><img class="options-icons" src="../Assets/Images/monitoring_FILL1_wght700_GRAD0_opsz48.svg" alt="reports"></span><h6>Reports</h6></div></a> 
        ...
        <div class="grid">
            <div class="top">
                <a style="text-decoration: none;" href="./add-client-form.html">
                    ...
                    <div class="cards">
                        <h1 class="titles">Create Report</h1>
                        <span> <img class="svg" src="../Assets/Images/edit_document_FILL0_wght400_GRAD0_opsz48.svg"> </span>
                   ...
                   <a style="text-decoration: none;" href=""> 
                        ...
                        <div class="cards">
                            <h1 class="titles">Import Report</h1>
                            <span><img class="svg" src="../Assets/Images/download_FILL0_wght400_GRAD0_opsz48.svg" alt="loan-dues"></span>
            ...
            <div class="bottom">
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                                <h1 class="titles">Delete Report</h1>
                    ...
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                            ...
                            <h1 class="titles">Export Report</h1>
                            <span><img class="svg" src="../Assets/Images/publish_FILL0_wght400_GRAD0_opsz48.svg" alt="payroll"></span>
