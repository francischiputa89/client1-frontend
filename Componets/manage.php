...
<body>
    <div class="main">
        <div class="container-fluid pannel">
            ...
            <a  id="active"  style="text-decoration: none;" href="manage.php"><div  class="options"> <span><img class="options-icons" src="../Assets/Images/manage_accounts_FILL1_wght700_GRAD0_opsz48.svg" alt="manage"></span><h6>Manage</h6></div></a> 
        ...
        <div class="grid">
            <div class="top">
                <a style="text-decoration: none;" href="./add-client-form.html">
                    ...
                    <div class="cards">
                        <h1 class="titles">Waiver</h1>
                        <span> <img class="svg" src="../Assets/Images/manage_history_FILL0_wght400_GRAD0_opsz48.svg"> </span>
                   ...
                   <a style="text-decoration: none;" href=""> 
                        ...
                        <div class="cards">
                            <h1 class="titles">Approve</h1>
                            <span><img class="svg" src="../Assets/Images/approval_delegation_FILL0_wght400_GRAD0_opsz48.svg" alt="loan-dues"></span>
            ...
            <div class="bottom">
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                                <h1 class="titles">Delete</h1>
                                <span><img class="svg" src="../Assets/Images/delete_forever_FILL0_wght400_GRAD0_opsz48.svg"></span>
                    ...
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                            ...
                            <h1 class="titles">Payroll</h1>
                            <span><img class="svg" src="../Assets/Images/account_balance_wallet_FILL0_wght400_GRAD0_opsz48.svg" alt="payroll"></span>
