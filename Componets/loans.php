<?php
    include"./nav-bar.php";
    include"../queries/count_application.php";
...
<body>
    <div class="main">
        <div class="container-fluid pannel">
            ...
            <a id="active" style="text-decoration: none;" href="loans.php"><div class="options"> <span><img class="options-icons" src="../Assets/Images/payments_FILL1_wght700_GRAD0_opsz48.svg" alt="loans"></span><h6>Loans</h6></div></a>
            ...
            <a  style="text-decoration: none;" href="settings.php"><div  class="options"> <span><img class="options-icons" src="../Assets/Images/settings_FILL1_wght700_GRAD0_opsz48.svg" alt="settings"></span><h6>Settings</h6></div></a> 
        ...
        <div class="grid">
            <div class="top">
                <a style="text-decoration: none;" href="./add_loan.php">

                    <div class="cards">
                        <h1 class="titles">New Loan</h1>
                        <span> <img class="svg" src="../Assets/Images/real_estate_agent_FILL0_wght400_GRAD0_opsz48.svg"> </span>
                   ...
                   <a style="text-decoration: none;" href=""> 
                        ...
                        <div class="cards">
                            <h1 class="titles">Active Loan</h1>
                            <span><img class="svg" src="../Assets/Images/donut_small_FILL0_wght400_GRAD0_opsz48.svg" alt="loan-dues"></span>
            ...
            <div class="bottom">
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                                <h1 class="titles">Closed Loans</h1>
                                <span><img class="svg" src="../Assets/Images/subtitles_off_FILL0_wght400_GRAD0_opsz48.svg"></span>

                        </div>
                    </a>

                    <a style="text-decoration: none;" href="./applications.php">
                        <div class="cards">

                            <h1 class="titles"><?php echo $count;?> Applications</h1>
                            <span><img class="svg" src="../Assets/Images/home_storage_FILL0_wght400_GRAD0_opsz48.svg" alt="loan-dues"></span>
