...
<body>
    <div class="main">
        <div class="container-fluid pannel">
            ...
            <a id="active" style="text-decoration: none;" href="clients.php"><div class="options"> <span><img class="options-icons" src="../Assets/Images/groups_FILL1_wght700_GRAD0_opsz48.svg" alt="clients"></span><h6>Clients</h6></div></a> 
        ...
        <div class="grid">
            <div class="top">
                <a style="text-decoration: none;" href="./add-client-form.php">

                    <div class="cards">
                        <h1 class="titles">New Clients</h1>
                        <span> <img class="svg" src="../Assets/Images/account_box_FILL1_wght700_GRAD0_opsz48.svg" alt="all-clients"> </span>
                   ...
                   <a style="text-decoration: none;" href=""> 
                        ...
                        <div class="cards">
                            <h1 class="titles">Payment</h1>
                            <span><img class="svg" src="../Assets/Images/sync_saved_locally_FILL1_wght700_GRAD0_opsz48.svg" alt="loan-dues"></span>
            ...
            <div class="bottom">
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                                <h1 class="titles">Charges</h1>
                                <span><img class="svg" src="../Assets/Images/running_with_errors_FILL1_wght700_GRAD0_opsz48.svg" alt="loan-dues"></span>
                    ...
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                            ...
                            <h1 class="titles">Pending</h1>
                            <span><img class="svg" src="../Assets/Images/hourglass_top_FILL1_wght700_GRAD0_opsz48.svg" alt="loan-dues"></span>
