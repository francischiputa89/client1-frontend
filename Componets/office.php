...
<body>
    <div class="main">
        <div class="container-fluid pannel">
            ...
            <a id="active"  style="text-decoration: none;" href="office.php"><div  class="options"> <span><img class="options-icons" src="../Assets/Images/apartment_FILL1_wght700_GRAD0_opsz48.svg" alt="office"></span><h6>Office</h6></div></a> 
        ...
        <div class="grid">
            <div class="top">
                <a style="text-decoration: none;" href="./add-client-form.html">
                    ...
                    <div class="cards">
                        <h1 class="titles">Add Office</h1>
                        <span> <img class="svg" src="../Assets/Images/domain_add_FILL0_wght400_GRAD0_opsz48.svg"> </span>
                   ...
                   <a style="text-decoration: none;" href="./all_depatments.php"> 

                        <div class="cards">
                            <h1 class="titles">Departments</h1>
                            <span><img class="svg" src="../Assets/Images/dns_FILL0_wght400_GRAD0_opsz48.svg" alt="loan-dues"></span>
            ...
            <div class="bottom">
                    <a style="text-decoration: none;" href="./add_department_form.php">
                        <div class="cards">
                                <h1 class="titles">Add Department</h1>
                                <span><img class="svg" src="../Assets/Images/domain_disabled_FILL0_wght400_GRAD0_opsz48.svg"></span>
                    ...
                    <a style="text-decoration: none;" href="">
                        <div class="cards">
                            ...
                            <h1 class="titles">Partners</h1>
                            <span><img class="svg" src="../Assets/Images/handshake_FILL0_wght400_GRAD0_opsz48.svg" alt="loan-dues"></span>
